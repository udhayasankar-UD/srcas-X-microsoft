...
const PrizesPage = () => {
  ...
  const outcomes = [
    ...
    { icon:'💰', title:'Cash Prize Pool', desc:'₹5,00,000+ distributed across categories — Grand Prize, Runner-ups, and Track Awards.' },
  ...
  const tiers = [
    ...
    { rank:'03', title:'Second Runner Up', amount:'₹25,000', desc:'Awarded for creativity and a unique approach to solving the problem statement.' },
  ];

  const trackAwards = [
    { icon:'⚡', title:'Best AI Integration', amount:'₹10,000' },
    { icon:'🌍', title:'Best Social Impact', amount:'₹10,000' },
    { icon:'🎨', title:'Most Creative UI/UX', amount:'₹10,000' },
  ];

  const tickerItems = ['₹5L+ Prize Pool','Microsoft Internship','Singapore Trip','Azure Credits','1:1 Mentorship','Open Innovation','17 UN SDGs','SRCAS 2026','Aug 14–16'];
