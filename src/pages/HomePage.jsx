      ...
      {showPopup && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
          ...
          >
            ...
            <h2 style={{ fontSize: 24, fontWeight: 900, color: '#111', marginBottom: 8 }}>Winners Announced!</h2>

            <p style={{ fontSize: 15, color: '#4b5563', lineHeight: 1.6, marginBottom: 24 }}>
              The wait is over! The top Championship winners for SRCAS Hackathon 3.0 have been announced — check it out! 🎉
            </p>

            <div style={{ display: 'flex', gap: 12, flexDirection: 'column' }}>
              <a href="/winners" style={{ width: '100%', padding: '14px', background: 'linear-gradient(135deg, #4C9F38, #2d7a2d)', color: '#fff', borderRadius: 12, fontWeight: 700, textDecoration: 'none', display: 'inline-block', fontSize: 15, boxShadow: '0 4px 12px rgba(76,159,56,0.35)' }}>
                🏆 View Winners
              </a>
              <button
