...
export default function Dock({
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className={`mx-2 flex max-w-full items-center z-50 ${className}`}>
      <motion.div
        onMouseMove={({ pageX }) => {
          isHovered.set(1);
          mouseX.set(pageX);
        ...
        className={`absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
